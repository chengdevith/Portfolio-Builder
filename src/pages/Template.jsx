...
import { ResumeComponent } from "../components/Card/helpers/ButtonComponent";
import { PortfolioComponent } from "../components/Card/helpers/ButtonComponent";
import { ActiveButton } from "../components/Card/helpers/ButtonComponent";
  ...
  return (
    <section>
      <div className="p-6 bg-gray-100 min-h-auto mb-20">
        ...
        <div className="container m-auto max-w-screen-lg flex justify-between items-center px-14">
          <div className="">
            <div className="flex space-x-4 items-center">
              ...
              {/* <button class="relative inline-flex items-center justify-center p-0.5  me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
                  ...
                  Portfolio <FontAwesomeIcon icon={faChevronDown} />
                  </span>
              </button> */}
            </div>
          </div>
          ...
          <form class=" w-1/2">
            ...
            <div class="relative p-0.5">
              ...
              <button
                type="submit"
                class="pt-1 text-white absolute end-2.5 bottom-2.5 bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                Search
              </button>
            </div>
