  ...
  return (
    <section className="w-full md:min-h-screen  bg-gradient-to-r from-purple-300 to-purple-600 px-4 md:px-10 lg:px-36 py-16 flex flex-col md:flex-row items-center justify-center">
      ...
      <div className="w-full md:w-1/2 grid grid-cols-2 gap-4 mt-8 md:mt-0">
        <img src={stu2} alt="Student" className="rounded-lg w-full h-auto shadow-lg" />
        <img src={second} alt="Second" className="rounded-lg w-full h-auto shadow-lg" />
        <img src={third} alt="Content" className="rounded-lg w-full h-auto shadow-lg" />
        <img src={creator} alt="Engineer" className="rounded-lg w-full h-auto shadow-lg" />
      </div>
    </section>
  );
};
