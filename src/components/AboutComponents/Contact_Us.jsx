  ...
  return (
    <div className="bg-gradient-to-b from-gray-100 to-white py-16 flex justify-center">
      <div className="max-w-6xl w-full flex flex-col lg:flex-row gap-8">
        {/* Contact Form */}
        <div className="w-full lg:w-1/2 bg-purple-700 text-white p-10 rounded-lg shadow-lg">
          ...
          <form className="space-y-4">
            ...
            <button className="w-full bg-purple-600 hover:bg-purple-900 text-white font-bold py-3 rounded-md">
              Send Message
            </button>
          </form>
        </div>
