                ...
                >
                  <ul className="block lg:flex">
                    <li className="group">
                      <a
                        href="#home"
                        className="mx-8 flex py-2 text-base font-semibold text-dark group-hover:text-primary dark:text-white"
                      >
                        Home
                      </a>
                    </li>
          ...
          <div className="container">
            <div className="flex flex-wrap">
              <div className="w-full self-center px-4 lg:w-1/2">
                ...
                <p className="my-quotes md:text-md mb-10 font-medium italic leading-relaxed text-secondary" />
                <a
                  href="#"
            ...
            >
              <div className="mx-auto mb-16 max-w-xl text-center">
                ...
                <p className="text-md font-medium text-secondary md:text-lg">
                  ...
                  animi ab iusto minus corporis sapiente incidunt deserunt
                  labore cum expedita!
                </p>
              </div>
            </div>
