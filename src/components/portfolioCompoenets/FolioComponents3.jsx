  ...
  const blogs = [
    {
      title: "Sample Blog 1",
      description:
        "This is a sample blog post about web development trends in 2025.",
      images: [],
    },
    {
      title: "Sample Blog 2",
      description:
        "This is a sample blog about modern JavaScript frameworks and their applications.",
      images: [],
    },
    {
      title: "Sample Blog 3",
      description:
        "Exploring the latest UI/UX design patterns for creating engaging user experiences.",
      images: [],
    },
    {
      title: "Sample Blog 4",
      description:
        "How AI is transforming the way we build and interact with digital products.",
      images: [],
    },
  ];
  ...
  const workExperiences = [
    {
      ...
      achievements: "Developed key features for the company's flagship product",
      job_description:
        "Developing software applications using modern web technologies",
      position: "Developer",
      responsibility:
        "Writing code, reviewing PRs, mentoring junior developers",
      work_address: "123 Main St",
      company_name: "Tech Inc.",
    },
    {
      job_title: "Frontend Engineer",
      hired_date: "2021-05-15T00:00:00Z",
      achievements:
        "Improved site performance by 40% through code optimization",
      job_description:
        "Building responsive user interfaces and implementing design systems",
      position: "Engineer",
      responsibility: "UI development, performance optimization, A/B testing",
      work_address: "456 Tech Blvd",
      company_name: "Digital Solutions",
    },
    {
      job_title: "Web Developer Intern",
      hired_date: "2020-06-01T00:00:00Z",
      achievements:
        "Created a new component library that reduced development time",
      job_description: "Supporting the development team with frontend tasks",
      position: "Intern",
      responsibility:
        "Building UI components, fixing bugs, website maintenance",
      work_address: "789 Innovation Ave",
  ...
  const projects = [
    {
      ...
      project_description:
        "A revolutionary web application that transforms how users manage their digital assets",
      link_to_project: "https://example.com/projectA",
      project_image: "/api/placeholder/400/300",
    },
    {
      project_title: "Project B",
      project_description:
        "Mobile-first e-commerce platform with advanced recommendation system",
      link_to_project: "https://example.com/projectB",
      project_image: "/api/placeholder/400/300",
    },
    {
      project_title: "Project C",
      project_description:
        "Data visualization dashboard for real-time analytics and business intelligence",
      link_to_project: "https://example.com/projectC",
      project_image: "/api/placeholder/400/300",
    },
    {
      project_title: "Project D",
      project_description:
        "AI-powered content management system with automated SEO optimization",
      link_to_project: "https://example.com/projectD",
      project_image: "/api/placeholder/400/300",
    },
  ];
